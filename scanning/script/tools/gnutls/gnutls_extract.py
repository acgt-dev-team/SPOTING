...
def main():
    header_files = [
        Path(r"C:\AGCT\library-sources\gnutls-3.8.13\lib\includes\gnutls\gnutls.h.in")
    ]
    ...
    with open("gnutls_api_database.json", "w", encoding="utf-8") as file:
        json.dump(export_data, file, indent=4)

    print("\nJSON exported to gnutls_api_database.json")
