...
def main():
    header_dir = Path(r"C:\AGCT\library-sources\mbedtls-3.6.6\include\mbedtls")
    ...
    with open("mbedtls_api_database.json", "w", encoding="utf-8") as file:
        json.dump(export_data, file, indent=4)

    print("\nJSON exported to mbedtls_api_database.json")
