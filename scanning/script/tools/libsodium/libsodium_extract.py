...
def main():
    header_dir = Path(r"C:\AGCT\library-sources\libsodium-win64\include\sodium")
    ...
    with open("libsodium_api_database.json", "w", encoding="utf-8") as file:
        json.dump(export_data, file, indent=4)

    print("\nJSON exported to libsodium_api_database.json")
