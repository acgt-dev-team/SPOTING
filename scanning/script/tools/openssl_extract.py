...
def main():
    header_dir = Path(r"C:\AGCT\library-sources\openssl-3.6.3\include\openssl")
    ...
    with open("openssl_api_database.json", "w", encoding="utf-8") as file:
        json.dump(export_data, file, indent=4)

    print("\nJSON exported to openssl_api_database.json")
